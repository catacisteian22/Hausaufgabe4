...
import com.company.exceptions.RepositoryExceptions.CourseRepoExceptions;
...
public class CourseFileRepository implements IFileRepository<Course> {
    ...
    public void setTeacherRepo(CrudRepository<Teacher> teacherRepo) {
